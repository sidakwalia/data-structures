...
public class l001 {
    ...
    public static int allNodeKAway_02(Node root, int target, int K) {
        ...
        int leftdistance = allNodeKAway_02(root.left, target, K);
        if (leftdistance != -1) {
            if (K - leftdistance >= 0) 
        ...
        int rightdistance = allNodeKAway_02(root.right, target, K);
        if (rightdistance != -1) {
